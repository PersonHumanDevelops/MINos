...
ld -m elf_i386 -T link.ld -o MINos/boot/kernel.bin kasm.o kc.o obj/isr.o obj/system.o obj/string.o obj/screen.o obj/kb.o obj/idt.o obj/util.o obj/shell.o
qemu-system-x86_64 -kernel MINos/boot/kernel.bin
grub-mkrescue MINos/boot/kernel.bin  -o MINos.iso MINos/
